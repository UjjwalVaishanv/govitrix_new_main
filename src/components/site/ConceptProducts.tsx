...
export const conceptProducts: Product[] = [
  {
    ...
    name: "Medicare HMS",
    category: "Healthcare",
    tagline: "Hospital Management & Clinical Operations Suite",
    description: "Comprehensive Hospital Management System streamlining patient EMR, doctor rostering, appointments, lab reports, pharmacy, billing, and administrative workflows in a unified platform.",
    ...
    solution: "A modular HMS built with Java Spring Boot and React that unifies patient records, scheduling, billing, pharmacy, labs, and inventory with role-based access, HIPAA-aligned workflows, and real-time operational analytics.",
    features: [
      "Real-time Admin Dashboard (Live metrics, revenue ₹72.1k MTD & visit trends)",
      "Reports & Analytics suite (Appointments per day, doctor activity & exports)",
      "Doctor Staff Directory & queue management (Cardiology, Pediatrics, OPD)",
      "Appointment status pipeline (Completed, In-progress, Checked-in, Booked)",
      "Pharmacy & inventory management with audit logs",
  ...
  },
  {
    ...
    name: "SellMate",
    category: "Sales & CRM",
    tagline: "Sales Command Center & E-commerce Intelligence",
    description: "All-in-one sales command center and analytics platform streamlining order processing, catalog management, revenue tracking, conversion funnels, payment collections, and AI business insights.",
    challenge: "E-commerce and retail sales teams struggle with fragmented tools for catalog, orders, payments, returns, and conversion analytics — leading to missed sales and slow fulfillment.",
    solution: "A unified Sales Command Center and Analytics dashboard featuring real-time health score monitoring, revenue & profit trends, order conversion funnels, payment status management, and AI smart growth insights.",
    features: [
      "Real-time Sales Command Center & Health Score (82/100)",
      "Revenue & profit trend analytics over 7/30/90 days",
      "Order conversion funnel tracking (Enquiries → Delivered)",
      "Payments dashboard (Total collected, pending & overdue tracking)",
      "Smart AI Insights & automated business recommendations",
      "Catalog, order management, customer retention & shipping automation",
    ],
    stack: ["React", "TypeScript", "Node.js", "Tailwind CSS", "PostgreSQL", "Recharts"],
    results: [
      { value: "82/100", label: "Health score" },
      { value: "68%", label: "Conversion rate" },
      { value: "+38%", label: "Win rate uplift" },
    ],
    accent: "from-indigo-600/20 via-purple-600/10 to-blue-500/20",
    dotColor: "bg-indigo-500",
    screenshots: [
      "/projects/sellmate-1.png",
      "/projects/sellmate-2.png",
      "/projects/sellmate-3.png",
      "/projects/sellmate-4.png",
    ],
  },
  {
    slug: "anahata-ai",
    ...
    tagline: "Reflective AI Companion & Personal Clarity Space",
    description: "An intelligent, reflective AI companion providing a calm space to think clearly, process emotions safely, and journal with private AI guidance.",
    challenge: "Modern life generates continuous cognitive noise, stress, and anxiety — yet people lack a private, non-judgmental space to reflect, process thoughts, and find daily clarity.",
    solution: "An empathetic mobile companion application powered by AI natural language processing, seamless Google & email authentication, guided journaling workflows, and end-to-end privacy for user reflections.",
    features: [
      "Empathetic reflective conversational AI",
      "Guided journal prompts & emotional reflection",
      "Secure Google & email single sign-on",
      "End-to-end encrypted private reflection storage",
      "Mindful UI with lotus theme & warm soothing aesthetics",
      "Instant conversation starter & reflection history",
    ],
    stack: ["Python", "LangChain", "OpenAI", "React Native", "FastAPI", "PostgreSQL"],
    results: [
      { value: "4.9★", label: "App Store rating" },
      { value: "85%", label: "Mindful clarity score" },
      { value: "100%", label: "Private & secure" },
    ],
    accent: "from-rose-500/20 via-amber-500/10 to-orange-500/20",
    dotColor: "bg-rose-500",
    screenshots: [
      "/projects/anahata-1.png",
      "/projects/anahata-2.png",
    ],
  },
];
